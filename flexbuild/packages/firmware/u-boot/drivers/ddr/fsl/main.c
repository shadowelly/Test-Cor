...
/*Senao*/
                pinfo->fsl_ddr_config_reg[i].ddr_cdr1=0x80080000;
                pinfo->fsl_ddr_config_reg[i].ddr_cdr2=0x0000a180;
                pinfo->fsl_ddr_config_reg[i].ddr_sdram_mode=0x01010214;

                pinfo->fsl_ddr_config_reg[i].timing_cfg_3=0x01111000;
                pinfo->fsl_ddr_config_reg[i].timing_cfg_0=0xd0550018;
                pinfo->fsl_ddr_config_reg[i].timing_cfg_2=0x0048C114;
                pinfo->fsl_ddr_config_reg[i].ddr_sdram_interval=0x0C300300;
                pinfo->fsl_ddr_config_reg[i].ddr_sdram_clk_cntl=0x02000000;
                pinfo->fsl_ddr_config_reg[i].timing_cfg_7=0x23300000;
/*End Senao*/
